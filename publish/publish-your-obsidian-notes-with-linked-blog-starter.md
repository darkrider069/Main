...
![[DR/publish/attachments/fork-linked-blog-starter-md.png]]
...
![[DR/publish/attachments/configure-project-vercel.png]]
...
![[DR/publish/attachments/disconnect-repo-vercel.png]]
7. Then, [[DR/publish/get-project-id-account-id-and-token-vercel|get the account id, project id and token from vercel]]
...
![[DR/publish/attachments/github-secrets-vercel.png]]
9. Finally, click "Actions", and enable the workflow
![[DR/publish/attachments/enable-actions-github.png]]
...
Optionally, you can:
- [[DR/publish/connect-obsidian-vault-with-github|Publish Notes within your Obsidian Vault]] by installing the Obsidian Git plugin
- [[DR/publish/update-publish-settings-github-actions|Update the publish settings]] to publish your notes to a [[DR/publish/deploy-a-custom-linked-blog-starter|custom version]] of the linked-blog-starter 