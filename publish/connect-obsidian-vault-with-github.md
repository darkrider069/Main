...
1. Create a repository or [[DR/publish/publish-your-obsidian-notes-with-linked-blog-starter|fork the md repo]] in github
...
![[DR/publish/attachments/create-pat-github.png]]
...
![[DR/publish/attachments/clone-repo-git-plugin.png]]
